...
QuestionList CreateEnglishWordExam()
{
    const struct {
        ...
        {"infrastructure","インフラストラクチャ","下部構造、基盤となる施設や整備"},
        {"knowledge","ナレッジ","知識"},
        {"credit","クレジット","信用"},
...
QuestionList CreateEnglishPhraseExam() {
    const struct {
        ...
        "As soon as I arrive,I will call you.","到着したらすぐ電話します。",
        3,{0,1,2}},
        ...
        1,{1}},
        {"both [A] and [B]","[A]と[B]両方とも",
        "This bag is both quality and cheap.","このかばんは品質が良いうえに安い。",
        2,{3,5}},
        {"either [A] or [B]","[A]も[B]も両方ともない",
        "Mom says that you can have either a dog or a cat.","母は、犬か猫のどちらかなら飼っていもいいと言っている。",
        2,{6,9}},
